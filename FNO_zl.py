...
run = Run()
run.init(folder="/FNO_MHD/pre_IAEA", tags=['Single-Blob', 'MultiVariable', "Z_Li", "Skip-connect", "Recon", "Finals", "Normalisation-test_train"], metadata=configuration)
...
nmse = ((pred_set - test_u).pow(2).mean() / test_u.pow(2).mean())
